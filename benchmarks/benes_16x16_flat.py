"""16x16 Benes with every switch expanded into its primitives.
...
flags are those of `benes_16x16.py`; only the switch cells are flattened
...
from benchmarks.benes_16x16 import NETWORK_SIZE, STABLE_ROUTING_ENV, STABLE_ROUTING_FLAGS
...
def build_schematic() -> Schematic:
    """Build the expanded 16x16 Benes benchmark schematic."""
