"""32x32 Benes with every switch expanded into its primitives.
...
flags are those of `benes_32x32.py`; only the switch cells are flattened
...
from benchmarks.benes_32x32 import NETWORK_SIZE, STABLE_ROUTING_ENV, STABLE_ROUTING_FLAGS
...
def build_schematic() -> Schematic:
    """Build the expanded 32x32 Benes benchmark schematic."""
