"""4x4 Benes with every switch expanded into its primitives.
...
flags are those of `benes_4x4.py`; only the switch cells are flattened
...
from benchmarks.benes_4x4 import NETWORK_SIZE
...
def build_schematic() -> Schematic:
    """Build the expanded 4x4 Benes benchmark schematic."""
