"""multiportmmi_64x64_bands6to9: slice of multiportmmi_64x64 keeping the columns mmi0_ps_array_1 .. mol_array_1
(198 instances, 256 nets), generated 2026-09-15 by
...
BENCHMARK_YAML = Path(__file__).with_name("data") / "multiportmmi_64x64_bands6to9.yml"
N = 64
...
def build_schematic() -> Schematic:
    """Build the multiportmmi_64x64_bands6to9 schematic."""
