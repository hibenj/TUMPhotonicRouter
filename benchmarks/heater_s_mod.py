...
def build_schematic() -> Schematic:
    ...
    schematic.add_instance(
        "mmi_extra_3",
        mmi_instance,
        Placement(x=extra_mmi3_x, y=extra_mmi3_center_y, rotation=0),
    )
    schematic.add_instance(
        "mmi_extra_4",
        mmi_instance,
    ...
    schematic.add_instance(
        "mmi_extra_5",
        mmi_instance,
        Placement(x=extra_mmi5_x, y=extra_mmi5_center_y, rotation=0),
    )
    schematic.add_instance(
        "mmi_extra_6",
        mmi_instance,
    ...
    for lane_idx, center_y in enumerate(lane_centers_y):
        ...
        schematic.add_instance(
            f"gc_in_{upper_idx}",
            gc_instance,
            Placement(x=input_gc_x, y=gc_y_positions[upper_idx], mirror=True),
        )
        schematic.add_instance(
            f"gc_in_{lower_idx}",
            gc_instance,
            Placement(x=input_gc_x, y=gc_y_positions[lower_idx], mirror=True),
        )
        schematic.add_instance(
            f"mmi_a_{lane_idx}",
            mmi_instance,
        ...
        schematic.add_instance(
            f"gc_out_{upper_idx}",
            gc_instance,
            Placement(x=upper_output_x, y=gc_y_positions[upper_idx], rotation=0),
        )
        schematic.add_instance(
            f"gc_out_{lower_idx}",
            gc_instance,
            Placement(x=lower_output_x, y=gc_y_positions[lower_idx], rotation=0),
        )
