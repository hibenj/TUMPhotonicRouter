...
def build_schematic() -> Schematic:
    ...
    for lane_idx, center_y in enumerate(lane_centers_y):
        ...
        upper_output_x = extra_output_gc_x if upper_idx in {2, 4} else output_gc_x
        lower_output_x = extra_output_gc_x if lower_idx in {1, 3} else output_gc_x
        schematic.add_instance(
            f"gc_out_{upper_idx}",
            gc_instance,
    ...
    extra_nets = [
        ...
        Net(
            p1="mmi_extra_3,o3",
            p2="gc_out_2,o1",
            name="mmi_extra_3_upper_to_gc_out_2",
        ),
        Net(
            p1="mmi_extra_3,o4",
            p2="mmi_extra_4,o2",
        ...
        Net(
            p1="mmi_extra_5,o3",
            p2="gc_out_3,o1",
            name="mmi_extra_5_upper_to_gc_out_3",
        ),
        Net(
            p1="mmi_extra_5,o4",
            p2="gc_out_4,o1",
            name="mmi_extra_5_lower_to_gc_out_4",
        ),
    ]
