"""64x64 Benes with every switch expanded into its primitives.
...
flags are those of `benes_64x64.py`; only the switch cells are flattened
...
def build_schematic() -> Schematic:
    """Build the expanded 64x64 Benes benchmark schematic."""
