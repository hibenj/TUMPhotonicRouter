"""multiportmmi_64x64_bands4to5: slice of multiportmmi_64x64 keeping the columns mmi0_ps_array_0 .. mmi0_ps_array_1
(139 instances, 128 nets), generated 2026-09-15 by
...
BENCHMARK_YAML = Path(__file__).with_name("data") / "multiportmmi_64x64_bands4to5.yml"
N = 64
...
def build_schematic() -> Schematic:
    """Build the multiportmmi_64x64_bands4to5 schematic."""
