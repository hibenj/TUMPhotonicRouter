"""128x128 Benes with every switch expanded into its primitives.
...
flags are those of `benes_128x128.py`; only the switch cells are flattened
...
from benchmarks.benes_128x128 import (
    NETWORK_SIZE,
    STABLE_ROUTING_ENV,
...
def build_schematic() -> Schematic:
    """Build the expanded 128x128 Benes benchmark schematic."""
    return build_benes_schematic(NETWORK_SIZE, expand_switches=True, stage_pitch_um=STAGE_PITCH_UM)
