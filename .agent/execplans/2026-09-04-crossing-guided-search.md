...
- [ ] S2 A/B on the six benchmarks (budget 1, `scratchpad/s2.summary`) vs the 16:20 S1 numbers: expansions, verdicts, over-budget counts.
- [ ] S3 (optional): O3 plan-driven order.
