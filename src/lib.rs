...
pub use geometry_realization::{
    ...
    plan_auto_analytic_meander_for_route_depth_sweep, realize_route_polygon,
    ...
    AutoRouteAnalyticMeanderPlan, DenseOccupancyPrefix, GeometryError, GeometryGridSpec, GridRect,
    PortAccess, PortAccessConfig, PortAccessError, RouteAnalyticMeanderPlan,
};
pub use meander::{
